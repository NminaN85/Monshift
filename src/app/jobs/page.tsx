          ...
          <div style={{ background: "white", width: "100%", maxWidth: "480px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px", padding: "20px", boxSizing: "border-box" }}>
            {step === 1 && (
              <div>
                ...
                <input type="text" placeholder="اسم مكان العمل..." value={name} onChange={(e) => setName(e.target.value)} style={{ width: "100%", padding: "12px", borderRadius: "10px", border: "1px solid #d1d5db", fontSize: "16px", boxSizing: "border-box", marginBottom: "20px" }} />
                <button onClick={() => { if(name.trim()) setStep(2); }} style={{ width: "100%", padding: "14px", background: "#1e3a8a", color: "white", border: "none", borderRadius: "10px", fontWeight: "bold", fontSize: "15px" }}>Suivant</button>
              </div>
            )}
            {step === 2 && (
              <div>
                <h3 style={{ fontSize: "16px", marginBottom: "4px" }}>Quel est votre taux ? (Brut)</h3>
